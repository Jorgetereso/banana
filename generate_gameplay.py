...
STYLE = (
    ...
    "Stylized 3D visuals in the language of GTA V / Far Cry with semi-realistic painted textures, "
    "slightly exaggerated proportions, punchy saturation, real-time lighting, mild bloom, subtle "
    "screen-space ambient occlusion. World is BANANA AIRWAYS, a rundown ultra-low-cost airline with "
    "chaotic low-budget energy: worn red-and-yellow branding across seats, luggage carts, safety "
    "stickers, food trays, and maintenance equipment, banana-shaped decals everywhere, battered "
    "yellow-and-red propeller aircraft parked nearby.\n\n"
    "IMPORTANT: all characters MUST faithfully match the uploaded reference characters exactly in "
    "shape language, facial structure, proportions, fur texture, eye placement, lip design, color "
    "palettes, clothing language, and overall silhouette consistency. Do not redesign or reinterpret "
    "them. Preserve the exact identity and recognizable appearance of the reference cast across the "
    "scene.\n\n"
    "Scene populated with these same fuzzy googly-eyed airline workers and passengers from the "
    "reference images, featuring thick rubber lips, oversized white eyes, colorful fur, and absurd "
    "expressive body language. Maintain strict visual continuity with the references, as if this "
    "were gameplay from an established AAA stylized game franchise.\n\n"
    "Player seen in first person with hands and forearms visible at the bottom of frame, matching "
    "the same stylized art direction and proportions as the reference characters. Fingerless work "
    "gloves, slightly chunky cartoon anatomy. Slight wide-angle lens around 90° FOV. Clean gameplay "
    "frame.\n\n"
    "NO photorealism.\n"
    "NO character redesigns.\n"
    "NO generic mascot creatures.\n"
    "NO ray-traced reflections.\n"
    "NO cinematic film grain.\n"
    "NO realistic humans."
)
