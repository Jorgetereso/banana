...
CAST_NOTE = (
    "CHARACTERS — the characters shown must EXACTLY match the attached reference images: "
    "(1) ORANGE CHUBBY character with red crest, big green frog-like eyes, thick coral-pink lips, "
    "fluffy spiky orange fur, rotund muscular body. "
    "(2) GREEN PIGTAILS character with two long braided pigtails tied with green ribbons, droopy green eyes, "
    "thick coral lips, red bandana around neck, white name tag, mossy green fur. "
    "(3) PURPLE MUSCLE character with bright orange crest and orange lips, droopy small eyes, "
    "huge muscle-bound torso with abs, orange feet, very flexed pose. "
    "(4) RED MUSTACHE character with luxurious dark-red handlebar mustache, sleepy green eyes, red bandana, "
    "white name tag, dark red fur. "
    "(5) PURPLE OCTOPUS ALIEN — translucent purple, green pacifier-like beak, suction-cup "
    "tentacles, used as a face-hugger that latches onto a character's head. "
    "Do not invent other characters. Stick exactly to the design language of the references."
)
